...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		// method
		Component Header = createHeader("Garry's Mod");
		...
		// your game looks like Figure 1 in the Jeopardy Handout - c.
...
askQuestion("What Game content is included in the default game?","Half-Life",200);
...
if(buttonPressed==secondButton){
	...
	askQuestion("What Day, Month, and Year was Garry's Mod created?","December 24, 2004",400);
}
...
String quizQuestion = JOptionPane.showInputDialog(question);
		// If the answer is correct
if(quizQuestion.equalsIgnoreCase(correctAnswer)){
...
JOptionPane.showMessageDialog(null,"Sorry, you got that question incorrect. The correct answer was "+correctAnswer);
		// Call the updateScore() method
updateScore();
}
	}
	...
	/*
	 * public void playJeopardyTheme() { try { AudioInputStream audioInputStream
	 * = AudioSystem.getAudioInputStream(new
	 * URL("http://school.wintrisstech.org/sounds/jeopardy.wav")); Clip clip =
