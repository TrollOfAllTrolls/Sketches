...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	FortuneTeller() throws Exception {
		...
		// package
		fortuneTellerImage = ImageIO.read(getClass()
				.getResource("SpyCrab.jpeg"));
	...
	static void begin() {
		...
		JOptionPane
				.showMessageDialog(
						null,
						"Hello, User. Today, I am going to Answer a Yes or No Question for You, but You Must First Give my Tummy a Rub!");
	}
